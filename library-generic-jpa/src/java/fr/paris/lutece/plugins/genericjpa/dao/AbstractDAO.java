...
import fr.paris.lutece.plugins.genericjpa.dao.commons.PagedQuery;
 ...
 */
public abstract class AbstractDAO<K, E> extends JPALuteceDAO<K, E> implements IPluginDAO<K, E>
{
     ...
     */
    protected void buildCriteriaQuery( AbstractFilter<K> filter, Root<E> root, CriteriaQuery<E> cq, CriteriaBuilder cb )
    {
