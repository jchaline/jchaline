...
<html>
	...
	<body>
		<a href="#edit-artifact" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-artifact" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:artifactInstance, action:'update']" method="PUT" >
